...
for ((i=0; i<$length_ckpt; i++)); do
    ...
    python train_cls_MLP.py --alpha 16000 --resolution 256 --prefix $prefix_text --init_ckpt_original $ckptdir

    # for i in {16000,640,160,80,40,1}
    # do
    #     python train_cls_MLP.py --alpha $i --resolution 256 --prefix $prefix_text --init_ckpt_original $ckptdir
    # done
