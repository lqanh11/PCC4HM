...
def test(filedir, ckptdir_list, outdir, resultdir, scaling_factor=1.0, rho=1.0, res=1024, normal=False):
    # load data
...
if __name__ == '__main__':
    ...
    #                 './ckpts/r7_0.4bpp.pth']
    # ckptdir_list = ['./ckpts/r7_0.4bpp.pth']
    
    # ckptdir_list = ['../logs/modelnet_normal_resample_128_alpha_0.25_000/ckpts/epoch_20.pth',
    #                 '../logs/modelnet_normal_resample_128_alpha_1.25_000/ckpts/epoch_49.pth',
    #                 '../logs/modelnet_normal_resample_128_alpha_2.5_000/ckpts/epoch_10.pth',
    #                 '../logs/modelnet_normal_resample_128_alpha_5.0_000/ckpts/epoch_25.pth',
    #                 '../logs/modelnet_normal_resample_128_alpha_10.0_000/ckpts/epoch_49.pth',
    #                 ]
    ckptdir_list = ['../logs/modelnet_dense_reconstruction_alpha_0.25_001/ckpts/epoch_49.pth',
                    '../logs/modelnet_dense_reconstruction_alpha_1.0_001/ckpts/epoch_49.pth',
                    '../logsmodelnet_dense_reconstruction_alpha_5.0_001/ckpts/epoch_49.pth',
                    '../logs/modelnet_dense_reconstruction_alpha_10.0_001/ckpts/epoch_49.pth',
                    ]
