...
if __name__ == '__main__':
    ...
    parser.add_argument("--init_ckpt_base", default='/media/avitech/Data/quocanhle/PointCloud/logs/PCGC_scalable/logs_ModelNet10/cls_only/20231230_encFIXa10_baseTRANc4_resolution128_alpha16000.0_000/best_model/epoch_1.pth')
    ...
    # model
    print('='*10, 'Test', '='*10)
    model = PCCModel_Classification_Adapter().to(device)
