...
from tester_scalable import Test_Load_All
import random
import shutil
...
def parse_args():
    ...
    parser.add_argument("--init_ckpt_base", default='/media/avitech/Data/quocanhle/PointCloud/logs/PCGC_scalable/logs_ModelNet10/cls_only/20231230_encFIXa10_baseTRANc4_keepcoords_resolution128_alpha320.0_000/best_model/epoch_261.pth')
