...
from cls_adapter_downsamplecoords_trainer import Trainer
import random
import shutil
...
class TrainingConfig():
    def __init__(self, args):
        ...
        shutil.copy('cls_adapter_downsamplecoords_train.py', str(src_dir))
        shutil.copy('cls_adapter_downsamplecoords_trainer.py', str(src_dir))
