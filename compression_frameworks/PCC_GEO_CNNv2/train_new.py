...
def parse_args():
    ...
    parser.add_argument("--dataset", type=str, default='/media/avitech/Data/quocanhle/PointCloud/dataset/training_dataset/PCC_GEO_CNNv2/ModelNet40_200_pc512_oct3_4k/')
    parser.add_argument(
        "--alpha", type=float, default=0.75, dest="alpha",
        help='Focal loss alpha.')
    parser.add_argument(
        "--lmbda", type=float, default=5e-5, dest="lmbda", #1.0e-4 3.0e-4
    ...
    parser.add_argument(
        "--save_dir", type=str, default='/media/avitech/Data/quocanhle/PointCloud/logs/PCC_GEO_CNNv2', dest="save_dir",
        help='save checkpoint and log directory.')
    parser.add_argument(
        "--init_ckpt", type=str, default='', dest="init_ckpt",
        help='initial checkpoint directory.')
    parser.add_argument(
        "--prefix", type=str, default='04', dest="prefix",
