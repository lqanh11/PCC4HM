...
from data_utils.ModelNetDataLoader_h5 import ModelNetDataLoader_h5_all
...
def main(args):
    ...
    exp_dir = Path('/media/avitech/QuocAnh_1TB/Point_Cloud/logs/PointNet_cls/new')
    ...
    data_path = '/media/avitech/QuocAnh_1TB/Point_Cloud/dataset/modelnet10/pc_resample_format_h5/all_resolution'
    ...
    for epoch in range(start_epoch, args.epoch):
        ...
        with torch.no_grad():
            ...
            if (instance_acc >= best_instance_acc):
                ...
                best_epoch = epoch + 1
                instance_acc_test, class_acc_test = test(classifier.eval(), testDataLoader, num_class=num_class)

            if (class_acc >= best_class_acc):
                best_class_acc = class_acc
            log_string('Val Instance Accuracy: %f, Class Accuracy: %f' % (instance_acc, class_acc))
            log_string('[Epoch: %f] Best Val Instance Accuracy: %f, Class Accuracy: %f' % (best_epoch, best_instance_acc, best_class_acc))
            log_string('[Epoch: %f] Test Instance Accuracy: %f, Class Accuracy: %f' % (best_epoch, instance_acc_test, class_acc_test))
