...
class Encoder_1_scale(torch.nn.Module):
    def __init__(self, channels=[1,16,32,8]):
        super().__init__()
...
class Decoder_1_scale(torch.nn.Module):
    """the decoding network with upsampling.
    """
    def __init__(self, channels=[8,32,16]):
        super().__init__()
