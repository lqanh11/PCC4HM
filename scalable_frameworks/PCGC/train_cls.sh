...
LIST_ALPHA=(
    # "20231230_encFIXa025_baseTRANc4"
    # "20231230_encFIXa05_baseTRANc4"
    # "20231230_encFIXa1_baseTRANc4"
    # "20231230_encFIXa2_baseTRANc4"
    # "20231230_encFIXa4_baseTRANc4"
    # "20231230_encFIXa6_baseTRANc4"
    "20231230_encFIXa10_baseTRANc4"
)
...
for ((i=0; i<$length_ckpt; i++)); do
    ...
    for i in {16000,640,320,160,80,40,20,10,1}
    do
