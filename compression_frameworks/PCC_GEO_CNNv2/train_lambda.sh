...
for lambda_value in {1e-5,2e-05,5e-05,1e-04,3e-04}
    do
        python train_new.py --lmbda=$lambda_value\
                            --prefix=$lambda_value                        
    done
done

# python train_new.py --lmbda=5e-5\
#                 --init_ckpt='./models/5e-05/epoch_20_6319.pth' &&\

# python train_new.py --lmbda=1e-4\
#                 --init_ckpt='./models/0.0001/epoch_28_34927.pth' &&\

# python train_new.py --lmbda=5e-4\
#                 --init_ckpt='./models/0.0005/epoch_1_2110.pth' &&\

# python train_new.py --lmbda=1e-3\
#                 --init_ckpt='./models/0.001/epoch_24_30503.pth' &&\

# python train_new.py --lmbda=5e-3\
