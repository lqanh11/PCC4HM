...
if __name__ == '__main__':
    ...
    parser.add_argument("--data_split_path", default='/media/avitech/Data/quocanhle/PointCloud/Point_Cloud_Compression/data_split/uniform_resample/dense_normal')
    parser.add_argument("--outdir", default='./output')
    parser.add_argument("--resultdir", default='./results/dense_uniform_reconstruction')
    ...
    for idx_ckpt, ckptdir in enumerate(ckptdir_list):
        experiment_name = f'r{idx_ckpt+1}_' + ckptdir.split('/')[-2] + '_' + ckptdir.split('/')[-1]
    ...
    for index_file, filedir in tqdm(enumerate(filedirs['Test'])):
        ...
        if index_file >=0:
            print(index_file)
            all_results = test(filedir, ckptdir_list, args.outdir, normal=True)
