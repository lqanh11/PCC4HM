...
class ModelNetDataLoader_PCGC_scale(Dataset):
    def __init__(self, root, split_path, args, split='train', process_data=False):
        ...
        self.datapath = [(shape_names[i], os.path.join(self.root, shape_names[i], shape_ids[split][i]) + '.ply') for i
...
#     data = ModelNetDataLoader_PCGC_scale('/data/modelnet40_normal_resampled/', split='train')
