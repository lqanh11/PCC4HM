...
from cls_adapter_keepcoords_trainer import Trainer
import random
import shutil
import datetime
...
class TrainingConfig():
    def __init__(self, args):
        ...
        shutil.copy('cls_adapter_keepcoords_train.py', str(src_dir))
        shutil.copy('cls_adapter_keepcoords_trainer.py', str(src_dir))
