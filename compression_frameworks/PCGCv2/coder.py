...
if __name__ == '__main__':
    ...
    parser.add_argument("--filedir", default='/media/avitech/Data/quocanhle/PointCloud/dataset/modelnet40/pc_normal_resample_format_ply/128_dense_with_normal/airplane/airplane_0001.ply') 
