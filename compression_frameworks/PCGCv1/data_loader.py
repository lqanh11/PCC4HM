...
class PCDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if idx in self.cache:
            ...
            points = h5py.File(filedir, 'r')['data'][:].astype('int') 
...
def make_data_loader(dataset, batch_size=1, shuffle=True, num_workers=6, repeat=False, 
...
if __name__ == "__main__":
    filedirs = sorted(glob.glob('/userhome/PCGCv1/training-data-set/points64_part1_0/'+'*.h5'))
    ...
    test_dataset = PCDataset(filedirs[:100])
