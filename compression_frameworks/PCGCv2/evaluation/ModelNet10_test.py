...
from ModelNet_tester import Tester
...
def parse_args():
    ...
    parser.add_argument("--logdir", type=str, default='/media/avitech/QuocAnh_1TB/Point_Cloud/logs/PCGCv2')
    parser.add_argument("--prefix", type=str, default='modelnet_dense_full_reconstruction_with_pretrained_resolution256_alpha10.0_000', help="prefix of checkpoints/logger, etc.")
    parser.add_argument("--rate", type=str, default="r7")
    parser.add_argument("--outdir", type=str, default="./output/ModelNet/finetuning/")
...
class TestingConfig():
    def __init__(self, args):
        ckptdir = os.path.join(args.logdir, args.prefix, 'ckpts')

        self.resolution = args.resolution

        self.init_ckpt = os.path.join(ckptdir, 'epoch_10.pth')
