...
LIST_CKPT_BASE=(
  "/media/avitech/Data/quocanhle/PointCloud/logs/PCGC_scalable/logs_ModelNet10/cls_only/2024-01-11_00-04_encFIXa025_baseTRANc_mlp_resolution128_alpha16000.0_000/best_model/epoch_34.pth"
  "/media/avitech/Data/quocanhle/PointCloud/logs/PCGC_scalable/logs_ModelNet10/cls_only/2024-01-11_10-38_encFIXa05_baseTRANc_mlp_resolution128_alpha16000.0_000/best_model/epoch_37.pth"
  ...
  "/media/avitech/Data/quocanhle/PointCloud/logs/PCGC_scalable/logs_ModelNet10/cls_only/2024-01-10_21-03_encFIXa10_baseTRANc_mlp_resolution128_alpha16000.0_000/best_model/epoch_36.pth"
)
RESOLUTION=128
...
LIST_ALPHA=(
    "encFIXa025_baseTRANcMLP_scalable"
    "encFIXa05_baseTRANcMLP_scalable"
    ...
    "encFIXa10_baseTRANcMLP_scalable"
)
...
for ((i=0; i<$length_ckpt; i++)); do
    ...
    python train_scalable_MLP.py --alpha 0.5\
